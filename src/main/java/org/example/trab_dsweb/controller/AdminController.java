...
public class AdminController {
    ...
    public String showEditWorkerForm(@PathVariable UUID id, Model model) {
        ReturnWorkerDTO workerDTO = workerService.getWorkerById(id);
        ...
        model.addAttribute("formAction", "/api/admin/worker/edit/" + id);
    ...
    public String showEditEnterpriseForm(@PathVariable UUID id, Model model) {
        ReturnEnterpriseDTO enterpriseDTO = enterpriseService.getEnterpriseById(id);
        ...
        model.addAttribute("isEdit", true);
        model.addAttribute("formAction", "/api/admin/enterprise/edit/" + id);
